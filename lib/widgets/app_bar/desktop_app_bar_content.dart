...
class DesktopAppBarContent extends StatelessWidget {
  const DesktopAppBarContent({
    super.key,
...
class _SearchFieldState extends State<_SearchField> {
  ...
  void initState() {
    ...
    _focusNode.addListener(() {
      ...
      } else if (provider.searchController.text.trim().isEmpty) {
        provider.stopSearch();
      }
    });
  }
  ...
  @override
  Widget build(BuildContext context) {
    return Selector<CharactersProvider, TextEditingController>(
      selector: (context, provider) => provider.searchController,
      builder: (context, searchController, _) => TextField(
